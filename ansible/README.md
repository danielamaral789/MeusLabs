...
- Base de build: arquivos em `C:\Users\danie\OneDrive\Documentos\Projetos\MeuLabN8N\images\ansible_core`

## 3) Pre-requisitos
- Podman Desktop + Podman Machine ativos
- Arquivos do build disponiveis em `images\ansible_core`
